...
public class QueryTest {
    ...
    private void getTravelReviewWithQueryParam(String title) {
        Session session = factory.getCurrentSession();
        Transaction tx = session.getTransaction();
    ...
    private void getTravelReviewWithQueryParamList() {
        ...
        List<TravelReview> reviews = query.list();
        System.out.println("Method {getTravelReviewWithQueryParamList} \nresults:" + reviews);
    ...
    private void getTravelReviewWithSelect() {
        ...
        String SELECT_QUERY2 = "SELECT tr.title from TravelReview as tr";
        ...
        Query query2 = session.createQuery(SELECT_QUERY2);
        List<String> reviews2 = query2.list();

        System.out.println("Method {getTravelReviewWithSelect} results:\n");

        for (int i=0; i<reviews.size();i++) {
            System.out.println(reviews2.get(i)+ ":" + "\t" + reviews.get(i));
        }
    ...
    private void updateTravelReview() {
        ...
        Query query = session.createQuery("update TravelReview set review=:review where title='London'");
    ...
    private void deleteTravelReview() {
        ...
        Query query = session.createQuery("delete TravelReview where title='Venice'");
        int success = query.executeUpdate();
    ...
    public static void main(String[] args) {
        ...
        //test.getTravelReviewWithQueryParam(JOptionPane.showInputDialog("Please enter a city"));
